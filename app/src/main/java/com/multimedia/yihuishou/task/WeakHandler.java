...
public class WeakHandler {
    private Handler.Callback mCallback; // hard reference to Callback. We need to keep callback in memory
    ...
    public WeakHandler() {
        ...
        try {
            ...
            Looper.prepare();
            LogUtils.e("WeakHandler", "Throwable", "　new WeakHandler()　Throwable " + e.getMessage());
        }
        if (!initSuccess) {
            mCallback = null;
            mExec = new ExecHandler();
